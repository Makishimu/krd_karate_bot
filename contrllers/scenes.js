...
startWizardStep.on('text', async ctx => {
    ...
    await ctx.replyWithHTML(
        ...
        'По умолчанию, на вопросы отвечает сенсей - Самвел Александрович, но Вы можете написать обращение ' +
        'и к другому тренеру. Просто, напишите в начале текста, кому обращён Ваш вопрос.\n\n' +
...
sendContactsStep.on('text', async ctx => {
    ...
    await ctx.replyWithHTML(
        '<i>Такое сообщение будет прихожить в телеграм тренеру, сразу как кто-либо отправит запрос:</i>\n\n' +
        '<b>Внмание, поступил новый вопрос!</b>\n\n' +
